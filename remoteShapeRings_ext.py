...
cd {work_dir} || exit 1
/public/gkxiao/bin/RINGS_shapescreen.sh {file_name} {file_prefix}_RINGS_vs.log
"""
...
class RemoteShapeScreenExtension:
    ...
    def load(self):
        ...
        group = tab["Ligand"]
        control = group.add_button("RINGS ShapeVS", self._show_dialog)
        control.tooltip = ("Shape-based sreening against Peter Ertl's 4M ring systems.\n"
                           "Peter Ertl. (2024) Database of 4 Million Medicinal Chemistry-Relevant Ring Systems.\n"
                           "https://pubs.acs.org/doi/10.1021/acs.jcim.3c01812.\n"
                           "Requirements:\n"
